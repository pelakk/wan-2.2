...
download_model "https://huggingface.co/QuantStack/Wan2.2-T2V-A14B-GGUF/resolve/main/HighNoise/Wan2.2-T2V-A14B-HighNoise-Q8_0.gguf" "$DIFFUSION_MODELS_DIR/Wan2.2-T2V-A14B-HighNoise-Q8_0.gguf"

download_model "https://huggingface.co/QuantStack/Wan2.2-T2V-A14B-GGUF/resolve/main/LowNoise/Wan2.2-T2V-A14B-LowNoise-Q8_0.gguf" "$DIFFUSION_MODELS_DIR/Wan2.2-T2V-A14B-LowNoise-Q8_0.gguf"
...
download_model "https://huggingface.co/vrgamedevgirl84/Wan14BT2VFusioniX/resolve/main/FusionX_LoRa/Wan2.1_T2V_14B_FusionX_LoRA.safetensors" "$LORAS_DIR/Wan2.1_T2V_14B_FusionX_LoRA.safetensors"
download_model "https://huggingface.co/gsdfgfdgfddfh/instagirl/resolve/main/Instagirlv2.5-LOW.safetensors" "$LORAS_DIR/Instagirlv2.5-LOW.safetensors"
download_model "https://huggingface.co/gsdfgfdgfddfh/instagirl/resolve/main/Instagirlv2.5-HIGH.safetensors" "$LORAS_DIR/Instagirlv2.5-HIGH.safetensors"
download_model "https://huggingface.co/gsdfgfdgfddfh/instagirl/resolve/main/Lenovo.safetensors" "$LORAS_DIR/Lenovo.safetensors"
download_model "https://huggingface.co/gsdfgfdgfddfh/KURWA/resolve/main/Nicole_v2_High.safetensors" "$LORAS_DIR/Nicole_v2_High.safetensors"
download_model "https://huggingface.co/gsdfgfdgfddfh/KURWA/resolve/main/Nicole_v2_Low.safetensors" "$LORAS_DIR/Nicole_v2_Low.safetensors"
download_model "https://huggingface.co/Kijai/WanVideo_comfy/resolve/main/Lightx2v/lightx2v_T2V_14B_cfg_step_distill_v2_lora_rank256_bf16.safetensors" "$LORAS_DIR/lightx2v_T2V_14B_cfg_step_distill_v2_lora_rank256_bf16.safetensors"
...
# Use already cloned repo if available, otherwise clone
if [ -n "${CLONED_REPO_PATH:-}" ] && [ -d "$CLONED_REPO_PATH" ]; then
    echo "Using already cloned repo at $CLONED_REPO_PATH"
    REPO_WORKFLOWS_DIR="$CLONED_REPO_PATH"
else
    # Fallback: clone repo to get workflows
...
if [ -d "$REPO_WORKFLOWS_DIR/workflows" ]; then
    ...
    echo "⚠️  No workflows directory found in repo at $REPO_WORKFLOWS_DIR"
fi
